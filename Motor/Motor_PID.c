...
int32_t PID_M1_PosLocCalc(float NextPoint)
{
	...
	if(M1PID.SumError > 2000.0)					//积分限幅2300
		M1PID.SumError = 2000.0;
	else if(M1PID.SumError < -2000.0)
		M1PID.SumError = -2000.0;	
...
int32_t PID_M2_PosLocCalc(float NextPoint)
{
	...
	if(M2PID.SumError > 2000.0)					//积分限幅
		M2PID.SumError = 2000.0;
	else if(M2PID.SumError < -2000.0)
		M2PID.SumError = -2000.0;
